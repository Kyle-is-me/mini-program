...
Page({
  ...
  async createBil() {
    ...
    // 发送请求 创建订单
    const { order_number } = await request({ url: '/my/orders/create', method: 'post', data: { goods, order_price: totalPrice, consignee_addr: address.detailAddress }, header: { Authorization: token } })
